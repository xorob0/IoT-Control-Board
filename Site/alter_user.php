        ...
        <div class="header-dark">
            ...
            <div class="container d-flex hero" style="background-color:#ffffff;padding:0px;">
                ...
                <div class="d-flex flex-column flex-fill" style="padding:10px;">
                    ...
                    <form method="post" action="assets/php/alter_user.php">
...
?>
                        ...
                        <div class="form-group"><button class="btn btn-primary btn-block" type="submit" action="assets/php/changepwd.php">Change user's password</button></div>
                    </form>
                </div>
            </div>
        </div>
